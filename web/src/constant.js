...
if (window.ethereum) {
  ...
  try {
    ethereum.request({
      ...
      params: [{
        chainId: '0x198', // 408的十六进制
        chainName: 'Papers Chain',
        nativeCurrency: {
          name: 'MPSgas',
          symbol: 'MPSgas',
          decimals: 18
    ...
    // 如果添加网络失败，尝试直接切换到已有网络
    try {
      ethereum.request({
        method: 'wallet_switchEthereumChain',
        params: [{ chainId: '0x198' }], // 408的十六进制
      });
    } catch (switchError) {
  ...
  // 提供备选RPC
  web3 = new Web3(new Web3.providers.HttpProvider("http://128.1.40.107:9000"));
}
...
export const MarketplacecontractAddress = "0xe699ED3A02460E3AcE9bf157C5F1098CEb10C2B0";//12-3-2024 部署后
