      ...
      <el-form ref="form" :model="form" label-width="200px" :rules="rules">
        ...
        <el-form-item label="Paper Type" prop="paper_type">
          ...
          >
            ...
            <el-option label="Journal Paper" value="Journal Paper"></el-option>
          </el-select>
        </el-form-item>
...
<script>
import { submitPaper, getJournalDetail } from "../../api";
...
export default {
  ...
  methods: {
    ...
    async onSubmit() {
      ...
      formData.append("journal_id", this.$route.query.id);
