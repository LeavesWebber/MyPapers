...
type MPSRechargeOrder struct {
	...
	MPSAmount  float64   `gorm:"type:int;not null;comment:MPS数量" json:"mps_amount"`
...
type MPSTransaction struct {
	...
	MpsAmount   float64   `gorm:"type:int;not null;comment:MPS数量" json:"amount"`
...
type MPSBusinessTransferOrder struct {
	...
	MpsAmount         float64 `gorm:"type:int;not null;comment:出售的MPS数量" json:"mps_amount"`
